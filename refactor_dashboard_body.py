                    ...
                    ScrollView(.vertical, showsIndicators: false) {
                        VStack(alignment: .leading, spacing: Theme.Spacing.large) {
                            ...
                            DashboardHeaderView(
                                ...
                                alertCount: viewModel.activeAlerts.count
                            )
...
# Add alertCount and showAlerts to DashboardHeaderView
...
# Add Bell icon to DashboardHeaderView
bell_icon = """                
                ...
                .buttonStyle(.plain)"""
content = content.replace("Spacer()", "Spacer()\n" + bell_icon, 1)
